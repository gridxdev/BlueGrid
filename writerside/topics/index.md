...
<img src="create-project.png" alt="Create a new project" title="Create a new project" style="width:auto; height:auto; max-width:70%;">

<p>Select project type</p>
<img src="select-project-type.png" alt="Project Type dialog" title="Select project type" style="width:auto; height:auto; max-width:70%;">
...
<img src="open-browse.png" alt="Open an existing project" title="Open an existing project" style="width:auto; height:auto; max-width:70%;">

- Double-click on the project from the **Recent Projects** list.
<p>Open a recent project</p>
<img src="open-recent.png" alt="Open a recent project" title="Open a recent project" style="width:auto; height:auto; max-width:70%;">    
...
<img src="create-new-folder.png" alt="Create a new folder" title="Create a new folder" style="width:auto; height:auto; max-width:70%;">
<p><strong>Enter folder name</strong></p>
<img src="enter-folder-name.png" alt="Enter folder name" title="Enter folder name" style="width:auto; height:auto; max-width:70%;">
...
<p>Rename a folder</p>
<img src="rename-folder.png" alt="Rename a folder" title="Rename a folder" style="width:auto; height:auto; max-width:70%;">
...
<p>Delete a folder</p>
<img src="delete-folder.png" alt="Delete a folder" title="Delete a folder" style="width:auto; height:auto; max-width:70%;">
...
<img src="move-folder.png" alt="Move a folder to another folder" title="Move a folder to another folder" style="width:auto; height:auto; max-width:70%;">
...
<p>Sort folders</p>
<img src="sort-folders.png" alt="Sort folders" title="Sort folders" style="width:auto; height:auto; max-width:70%;">

#### 2.1.6 Filter Folders
In BlueGrid, you can filter folders by typing the filtering text into folder filter field.
<img src="filter-folders.png" alt="Filter folders" title="Filter folders" style="width:auto; height:auto; max-width:70%;">
##### Notes
...
<p>Open a page</p>
<img src="open-page.png" alt="Open a page" title="Open a page" style="width:auto; height:auto; max-width:70%;">
...
<img src="open-with.png" alt="Open PDF with external programs"  title="Open with external programs" style="width:auto; height:auto; max-width:70%;" /> 
...
<p>Open version</p>
<img src="open-version.png" alt="Open version" title="Open version" style="width:auto; height:auto; max-width:70%;">
...
<img src="add-pdf.png" alt="Add PDF pages to a folder" title="Add PDF pages to a folder" style="width:auto; height:auto; max-width:70%;">
...
<img src="drag-drop-pdf.png" alt="Drag and Drop PDF pages to a folder" title="Drag and Drop PDF pages to a folder" style="width:auto; height:auto; max-width:70%;">
<p>Confirm splitting PDFs</p>
<img src="confirm-split-pdf.png" alt="Confirm splitting PDF files into pages" title="Confirm splitting PDF files into pages" style="width:auto; height:auto; max-width:70%;">
...
<p>Replace a page</p>
<img src="replace-page.png" alt="Replace a page" title="Replace a page" style="width:auto; height:auto; max-width:70%;">
<p>Select page to replace with</p>
<img src="select-replace-page.png" alt="Select page to replace with" title="Select page to replace with" style="width:auto; height:auto; max-width:70%;">
...
<img src="duplicate-page.png" alt="Duplicate a page" title="Duplicate a page" style="width:auto; height:auto; max-width:70%;">
...
<img src="add-version.png" alt="Add version to a page" title="Add version to a page" style="width:auto; height:auto; max-width:70%;">
<p>Select the page as the new  version</p>
<img src="select-version-page.png" alt="Select the page as the new version" title="Select the page as the new version" style="width:auto; height:auto; max-width:70%;">
...
<p>Rotate a page</p>
<img src="rotate-pages.png" alt="Rotate a page" title="Rotate a page" style="width:auto; height:auto; max-width:70%;">
...
<p>Export pages</p>
<img src="export-pages.png" alt="Export pages" title="Export pages" style="width:auto; height:auto; max-width:70%;">
...
<p>Delete pages</p>
<img src="delete-page.png" alt="Delete pages" title="Delete pages" style="width:auto; height:auto; max-width:70%;">
...
<img src="delete-version.png" alt="Delete page version" title="Delete page version" style="width:auto; height:auto; max-width:70%;">>
...
<img src="change-thumbnail-size.png" alt="Change thumbnail size" title="Change thumbnail size" style="width:auto; height:auto; max-width:70%;">
...
<p>Sort pages</p>
<img src="sort-pages.png" alt="Sort pages" title="Sort pages" style="width:auto; height:auto; max-width:70%;">
...
<img src="batch-rename-pages.png" alt="Batch rename pages" title="Batch rename pages" style="width:auto; height:auto; max-width:70%;">   
...
<img src="batch-set-unit.png" alt="Set unit to multiple pages" title="Set unit to multiple pages" style="width:auto; height:auto; max-width:70%;">
...
<img src="move-page-to-folder.png" alt="Move a page to another folder" title="Move a page to another folder" style="width:auto; height:auto; max-width:70%;">
...
<img src="edit-page-name.png" alt="Set page name" title="Set page name" style="width:auto; height:auto; max-width:70%;">  
...
<img src="edit-page-scale.png" alt="Set page scale" title="Set page scale" style="width:auto; height:auto; max-width:70%;">
...
<img src="edit-page-unit.png" alt="Set page unit" title="Set page unit" style="width:auto; height:auto; max-width:70%;">
...
<img src="scale-tool.png" alt="Set page scale with Scale Tool" title="Set page scale with Scale Tool" style="width:auto; height:auto; max-width:70%;">
...
<img src="dim-tool.png" alt="Measure distances with Dim Tool" title="Measure distances with Dim Tool" style="width:auto; height:auto; max-width:70%;">   
...
<p>Pan tool</p>
<img src="pan-tool.png" alt="Pan tool" title="Pan tool" style="width:auto; height:auto; max-width:70%;">
...
<img src="select-tool.png" alt="Select tool" title="Select tool" style="width:auto; height:auto; max-width:70%;">
...
<p>Shape tool</p>
<img src="shape-tool.png" alt="Shape tools" title="Shape tools" style="width:auto; height:auto; max-width:70%;">
...
<img src="rectangle-tool.png" alt="Create rectangle shape" title="Create rectangle shape" style="width:auto; height:auto; max-width:70%;">
...
<img src="polyline-shape.png" alt="Create polyline shape" title="Create polyline shape" style="width:auto; height:auto; max-width:70%;">
...
<img src="polygon-shape.png" alt="Create polygon shape" title="Create polygon shape" style="width:auto; height:auto; max-width:70%;">
...
<img src="line-shape.png" alt="Create line shape" title="Create line shape" style="width:auto; height:auto; max-width:70%;">
...
<img src="path-shape.png" alt="Create path shape" title="Create path shape" style="width:auto; height:auto; max-width:70%;">
...
<img src="text-tool.png" alt="Add text annotation" title="Add text annotation " style="width:auto; height:auto; max-width:70%;">
...
<img src="textbox-tool.png" alt="Add textbox annotation" title="Add textbox annotation" style="width:auto; height:auto; max-width:70%;"> 
...
<p>Cloud tool</p>
<img src="cloud-tool.png" alt="Add cloud annotation" title="Add cloud annotation" style="width:auto; height:auto; max-width:70%;">
...
<img src="multiple-point-cloud.png" alt="Add multiple point cloud annotation" title="Add multiple point cloud annotation" style="width:auto; height:auto; max-width:70%;">
...
<img src="arrow-tool.png" alt="Add arrow annotation" title="Add arrow annotation" style="width:auto; height:auto; max-width:70%;">
...
<img src="callout-tool.png" alt="Add callout annotation" title="Add callout annotation" style="width:auto; height:auto; max-width:70%;">
...
<p>Count tool</p>
<img src="count-tool.png" alt="Count tool" title="Count tool" style="width:auto; height:auto; max-width:70%;">
...
<img src="stamp-tool.png" alt="Add stamp to drawing" title="Add stamp to drawing" style="width:auto; height:auto; max-width:70%;">
...
<p>Snap settings</p>
<img src="snap-setting.png" alt="Snap settings" title="Snap settings" style="width:auto; height:auto; max-width:70%;">
...
<img src="add-material.png" alt="Add a new material" title="Add a new material" style="width:auto; height:auto; max-width:70%;">
...
<p>Edit material</p>
<img src="edit-material.png" alt="Edit material" title="Edit material" style="width:auto; height:auto; max-width:70%;">
...
<img src="import-materials.png" alt="Import materials" title="Import materials" style="width:auto; height:auto; max-width:70%;">
...
<p>Pull materials</p>
<img src="pull-material.png" alt="Pull materials" title="Pull materials" style="width:auto; height:auto; max-width:70%;">

<p>Select catalog item to pull materials</p>
<img src="select-catalog.png" alt="Select catalog item to pull materials" title="Select catalog item to pull materials" style="width:auto; height:auto; max-width:70%;">
...
<p>Delete material</p>
<img src="delete-materials.png" alt="Delete material" title="Delete material" style="width:auto; height:auto; max-width:70%;">>
...
<img src="export-materials.png" alt="Export materials" title="Export materials" style="width:auto; height:auto; max-width:70%;">
...
<img src="export-quantity-report.png" alt="Export quantity report to excel" title="Export quantity report to excel" style="width:auto; height:auto; max-width:70%;">
...
<img src="assign-material.png" alt="Assign material to shape" title="Assign material to shape" style="width:auto; height:auto; max-width:70%;">
...
<img src="remove-shapes-from-material.png" alt="Unassign material from shape" title="Unassign material from shape" style="width:auto; height:auto; max-width:70%;">
...
<img src="dematerialize-shape.png" alt="Dematerialize shapes" title="Unsubscribe shapes from all materials" style="width:auto; height:auto; max-width:70%;">
...
<p>Sort materials</p>
<img src="sort-materials.png" alt="Sort materials" title="Sort materials" style="width:auto; height:auto; max-width:70%;">
...
<img src="filter-materials.png" alt="Filter materials" title="Filter materials" style="width:auto; height:auto; max-width:70%;">
...
<img src="add-catalog-entry.png" alt="Create a new catalog" title="Create a new catalog" style="width:auto; height:auto; max-width:70%;">
...
<img src="add-catalog-material.png" alt="Add catalog material" title="Add catalog material" style="width:auto; height:auto; max-width:70%;">
...
<img src="edit-catalog-item.png" alt="Edit catalog item" title="Edit catalog item" style="width:auto; height:auto; max-width:70%;">
...
<img src="delete-catalog-item.png" alt="Delete catalog item" title="Delete catalog item" style="width:auto; height:auto; max-width:70%;">
...
<img src="import-catalog.png" alt="Import catalog" title="Import catalog" style="width:auto; height:auto; max-width:70%;">   
...
<img src="export-catalog.png" alt="Export catalog" title="Export catalog" style="width:auto; height:auto; max-width:70%;">